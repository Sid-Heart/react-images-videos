...
var VideoLightbox = function (_Component) {
	_inherits(VideoLightbox, _Component);

	function VideoLightbox(props) {
		_classCallCheck(this, VideoLightbox);

		var _this = _possibleConstructorReturn(this, (VideoLightbox.__proto__ || Object.getPrototypeOf(VideoLightbox)).call(this, props));
	...
	_createClass(VideoLightbox, [{
		...
		value: function preloadImageData(data, onload) {
			...
			var videoBox = document.getElementById('videoPreview');
		...
		value: function renderImages() {
			...
			return _react2.default.createElement(
				...
				!image.type || image.type === 'Image' ? _react2.default.createElement('img', {
					...
					'video',
					{ id: 'videoPreview', controls: true },
					_react2.default.createElement('source', { src: image.src })
